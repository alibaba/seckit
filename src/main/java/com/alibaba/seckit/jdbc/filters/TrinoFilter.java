 ...
 */
public class TrinoFilter extends DefaultFilter {
    @Getter
    @Setter
    ...
    static {
        ...
        propertyPatterns.put("clientTags".toLowerCase(), Pattern.compile("^[a-zA-Z0-9_\\-\\.:\\[\\],]+$"));
        propertyPatterns.put("accessToken".toLowerCase(), Pattern.compile("^[a-zA-Z0-9_\\-\\.:\\[\\]+/=]+$"));
        propertyPatterns.put("roles".toLowerCase(), headerPattern);
        propertyPatterns.put("extraCredentials".toLowerCase(), headerPattern);
        propertyPatterns.put("sessionProperties".toLowerCase(), headerPattern);
    }
