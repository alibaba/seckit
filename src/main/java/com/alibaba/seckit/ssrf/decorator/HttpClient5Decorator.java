...
public class HttpClient5Decorator extends AbstractDecorator {

    static Class<?> clientClass = classForNameQuietly("org.apache.hc.client5.http.impl.classic.HttpClientBuilder");
            ...
            try {
                invokeMethod(clientOrBuilder,
                        ...
                        new Class[] {
                                String.class,
                                String.class,
                                HttpClient5Interceptor.class.getInterfaces()[0]
                        },
